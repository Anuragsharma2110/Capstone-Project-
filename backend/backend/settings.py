...
# Email Configuration
# Default to console backend for local development, override with env vars for production
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'Capstone Admin <noreply@capstone.example.com>')
